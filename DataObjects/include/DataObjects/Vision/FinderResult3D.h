...
public:
	...
	FinderResult3D(int cameraid, double x, double y, double z, double ang1, double ang2, double ang3) : x(x), y(y), z(z), ang1(ang1), ang2(ang2), ang3(ang3) { this->cameraID = cameraid; }
