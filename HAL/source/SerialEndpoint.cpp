...
SerialEndpoint::SerialEndpoint(const std::string &devicename, int baud, IOThread &iothread)
: BaseStreamEndpoint<serial_port>(iothread), devicename(devicename), baud(baud) { }
