...
set(FLAGS "-mcpu=cortex-a8 -mfpu=neon -mfloat-abi=softfp -ftree-vectorize -ftree-vectorizer-verbose=3 -fdump-tree-vect")

set(CMAKE_SYSTEM_NAME Linux)
set(CMAKE_SYSTEM_VERSION 1)

set(CMAKE_C_COMPILER ${GUMSTIX_TOOLCHAIN_PATH}/arm-angstrom-linux-gnueabi-gcc)
set(CMAKE_C_FLAGS_RELEASE ${CMAKE_C_FLAGS_RELEASE} ${FLAGS} CACHE STRING "C compiler flags for gumstix release mode")
set(CMAKE_CXX_COMPILER ${GUMSTIX_TOOLCHAIN_PATH}/arm-angstrom-linux-gnueabi-g++)
set(CMAKE_CXX_FLAGS_RELEASE ${CMAKE_CXX_FLAGS_RELEASE} ${FLAGS} CACHE STRING "CXX compiler flags for gumstix release mode")
